        ...
        <el-row>
            <el-col :span="24">
                <el-row class="login-input-wrap">
                    ...
                    <el-col :span="14"><el-input class="elinputs" v-model="name" placeholder="请输入账号"></el-input></el-col>
                    <el-col :span="5"></el-col>
                </el-row>
                <el-row class="login-input-wrap">
                    <el-col :span="5" class="logico"><span class="iconfont">&#xe620;</span></el-col>
                    <el-col :span="14"><el-input class="elinputs" v-model="password" placeholder="请输入密码" show-password></el-input></el-col>
                    <el-col :span="5"></el-col>
                </el-row>
            </el-col>
